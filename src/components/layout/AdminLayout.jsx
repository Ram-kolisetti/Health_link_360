  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <motion.aside
        ...
        className="fixed top-0 left-0 z-40 h-screen w-70 bg-white shadow-lg"
      >
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div className="flex items-center justify-between h-16 px-4 border-b">
            <Link to="/admin" className="flex items-center space-x-2">
              <img src="/logo.png" alt="HealthLink360" className="w-8 h-8" />
              <span className="text-xl font-bold text-gray-800">HealthLink360</span>
            </Link>
            <button
